...
export async function main(ns) {
	...
	ns.run("/bot/bot.cfo.StageEight.js")
	...
	ns.run("/bot/bot.minions.StageEight.js")
	...
	ns.run("/bot/bot.hacktarget.StageEight.js")
	await ns.sleep(1000)

	var stageEightDone = false

	while (stageEightDone == false) {
		stageEightDone = ns.read("/savedVar/stageEightDone.txt") === "true" ? true : false;
		await ns.sleep(60000)

	}
	ns.tprint("Sleep now!")
	await ns.sleep(2000)
	// ns.singularity.destroyW0r1dD43m0n(4, "TheFatController.js")
