...
export async function main(ns) {
	...
	const initialServPurchSize = 4096
	...
	const bitrunnerDonationMoney = 21000000000000
	let homeRamUpgStageTwo = false
	const homeRamUpgStageTwoSize = 4194304
	const homeRamUpgStageTwoMoney = 1600000000000000
	let homeCoresUpg = false
	const homeCoresUpgSize = 8
	const homeCoresUpgMoney = 1600000000000000
	let augPurchStageTwo = false
	const augPurchStageTwoMoney = 350000000000000
	...
	if (bitrunnerDonation == false) {
		...
		ns.run("/donate/donate.bitrunners.js", 1, bitrunnerDonationMoney)
	...
	if (daedalusDone == false) {
		ns.tprint("Waiting on rep to purchase augments")
		while (daedalusDone == false) {
			daedalusDone = ns.read("/savedVar/daedalusDone.txt") === "true" ? true : false;
			await ns.sleep(30000)
		}
	}

	ns.tprint("D " + daedalusDone)
	await ns.sleep(5000)


	// augPurchStageTwo
	if (augPurchStageTwo == false && daedalusDone == true) {
		...
		ns.run("/utils/faction.buy.augment.js", 1, "BitRunners", "NeuroFlux Governor")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "Aevum", "PCMatrix")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "The Syndicate", "Combat Rib II")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "The Syndicate", "Combat Rib III")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "The Syndicate", "Augmented Targeting II")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "The Syndicate", "Augmented Targeting III")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "The Syndicate", "BrachiBlades")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "Slum Snakes", "SmartSonar Implant")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "Slum Snakes", "LuminCloaking-V1 Skin Implant")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "Slum Snakes", "LuminCloaking-V2 Skin Implant")
		await ns.sleep(5000)
		...
		ns.tprint("");
		ns.write("/savedVar/stageSixDone.txt", "true", "w")
