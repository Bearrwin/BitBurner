...
export async function main(ns) {
	...
	// a very simple script that uses the weaken and then the grow command on the 
	//target server.  This is used as an example to fire of a couple of high thread count
	// scripts to break a server and prep it for harvesting.
