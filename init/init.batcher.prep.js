...
export async function main(ns) {
	...
	// 	run /init/init.batcher.prep.js phantasy 10 25 10
	...
	let delayms = ns.args[3];
  // let runDuration = ns.args[4];
	var counterMax = 2400
	var counter = 1
	var hackDelay = false
	var hackDelayms = 0
	...
	let scriptTwo = "/ammo/cg1.single.js"
		let scriptRam = ((ns.getScriptRam(scriptOne) * weakThreads) + (ns.getScriptRam(scriptTwo) * growThreads))
