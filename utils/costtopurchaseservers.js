...
ns.tprint("")
ns.tprint("")
ns.tprint("Upgrade Cost ------------")
ns.tprint("128Gb " + `${ns.nFormat(s128 - s64, "$0.000a")} `);
ns.tprint("256Gb " + `${ns.nFormat(s256 - s128, "$0.000a")} `);
ns.tprint("512Gb " + `${ns.nFormat(s512 - s256, "$0.000a")} `);
ns.tprint("1Tb " + `${ns.nFormat(s1024 - s512, "$0.000a")} `);
ns.tprint("2Tb " + `${ns.nFormat(s2048 - s1024, "$0.000a")} `);
ns.tprint("4Tb " + `${ns.nFormat(s4096 - s2048, "$0.000a")} `);
ns.tprint("8Tb " + `${ns.nFormat(s8192 - s4096, "$0.000a")} `);
ns.tprint("16Tb " + `${ns.nFormat(s16384 - s8192, "$0.000a")} `);
ns.tprint("32Tb " + `${ns.nFormat(s32768 - s16384, "$0.000a")} `);
ns.tprint("64Tb " + `${ns.nFormat(s65536 - s32768, "$0.000a")} `);
ns.tprint("128Tb " + `${ns.nFormat(s131072 - s65536, "$0.000a")} `);
ns.tprint("256Tb " + `${ns.nFormat(s262144 - s131072, "$0.000a")} `);
ns.tprint("512Tb " + `${ns.nFormat(s524288 - s262144, "$0.000a")} `);
ns.tprint("1Pb " + `${ns.nFormat(s1048576 - s524288, "$0.000a")} `);
ns.tprint("------------")
