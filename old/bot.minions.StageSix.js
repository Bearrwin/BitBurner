...
export async function main(ns) {
	...
	while (true) {
		...
		if (
			playerFaction.includes("Aevum") &&
			aevumDone == false &&
			!Object.values(currentWork).includes("Aevum")
		) {
			csecDone = true
			ns.singularity.workForFaction("Aevum", "Security", false)
		}
		...
		if (
			...
			ns.singularity.getFactionRep("Aevum") >= 100000 &&
			daedalusDone == false &&
