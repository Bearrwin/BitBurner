...
export async function main(ns) {
	...
	const bitrunnerDonationMoney = 2100000000000
	...
	const augPurchStageTwoMoney = 230000000000000
	...
	if (bitrunnerDonation == false) {
		...
		ns.run("/donate/donate.bitrunners.js", 1, 2100000000000)
		ns.write("/savedVar/bitrunnersDone.txt", "true", "w")
		await ns.sleep(5000)
		ns.tprint("Donating money to Bitrunners");
	}
	...
	var daedalusDone = ns.read("/savedVar/daedalusDone.txt") === "true" ? true : false;
	var theSyndicateDone = ns.read("/savedVar/theSyndicateDone.txt") === "true" ? true : false;

	if (bitrunnersDone == false || daedalusDone == false || theSyndicateDone == false) {
		ns.tprint("Waiting on rep to purchase augments")
		while (bitrunnersDone == false || daedalusDone == false || theSyndicateDone == false) {
			bitrunnersDone = ns.read("/savedVar/bitrunnersDone.txt") === "true" ? true : false;
			daedalusDone = ns.read("/savedVar/daedalusDone.txt") === "true" ? true : false;
			theSyndicateDone = ns.read("/savedVar/theSyndicateDone.txt") === "true" ? true : false;
			await ns.sleep(30000)
		}
	}

	ns.tprint("D " + daedalusDone + " B " + bitrunnersDone + " S " + theSyndicateDone)
	await ns.sleep(5000)


	// augPurchStageTwo
	if (augPurchStageTwo == false && daedalusDone == true && bitrunnersDone == true && theSyndicateDone == true) {
		...
		ns.run("/utils/faction.buy.augment.js", 1, "The Syndicate", "The Shadow's Simulacrum")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "The Syndicate", "Bionic Legs")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "The Syndicate", "Bionic Spine")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "Tian Di Hui", "Nanofiber Weave")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "Ishima", "INFRARET Enhancement")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "The Syndicate", "HemoRecirculator")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "Ishima", "Combat Rib I")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "Ishima", "Augmented Targeting I")
		await ns.sleep(5000)
		ns.run("/utils/faction.buy.augment.js", 1, "New Tokyo", "NutriGen Implant")
		await ns.sleep(5000)
